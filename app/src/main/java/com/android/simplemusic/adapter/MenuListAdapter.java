...
import com.android.simplemusic.bean.MenuItem;
...
public class MenuListAdapter extends ArrayAdapter<MenuItem> {
    ...
    public MenuListAdapter(Context context, int resourceId, List<MenuItem> menuList) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        MenuItem menuListItem = menuList.get(position);
        View view;
